...
import { SINASCParser } from "./SINASCParser.js";

export class SINASCBasicParser implements SINASCParser {
    ...
    static instanceOf(dictionary: Map<string, (value: any) => any>) {
        return new SINASCBasicParser(dictionary);
    }

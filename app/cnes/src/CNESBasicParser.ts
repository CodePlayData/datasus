...
import { CNESParser } from "./CNESParser.js";

export class CNESBasicParser implements CNESParser {
    ...
    static instanceOf(dictionary: Map<string, (value: any) => any>) {
        return new CNESBasicParser(dictionary);
    }
